        ...
        for row in map:
            ...
            for tile in row:
                if tile == "0":
                    ...
                    tiles.append(Tile("Walkable tile 1.png",x*self.tile_size, y*self.tile_size,self.spritesheet,P_tiles))
                elif tile == "9":
                    tiles.append(Tile("Imp Tile 2.png",x*self.tile_size, y*self.tile_size,self.spritesheet,IMP_tiles))
##                elif tile == "12":
##                    tiles.append(Tile("Broken Pave Tile 1.png",x*self.tile_size, y*self.tile_size,self.spritesheet,P_tiles))
####                elif tile == "1":
